...
Thermostat.prototype = {
    ...
    _getStatus: function (callback) {
        ...
        return request.get({
            ...
            if (!error && response.statusCode === 200) {
                ...
                this.log.debug('Device response: %s', body)
    ...
    setTargetHeatingCoolingState: function (value, callback) {
        var url = this.apiroute + '/status/?changestatus=true&targetHeatingCoolingState=' + value
    ...
    setTargetTemperature: function (value, callback) {
        ...
        var url = this.apiroute + '/status/?changestatus=true&targetTemperature=' + value
    ...
    setCoolingThresholdTemperature: function (value, callback) {
        value = value.toFixed(1)
        var url = this.apiroute + '/status/?changestatus=true&coolingThresholdTemperature?value=' + value
    ...
    setHeatingThresholdTemperature: function (value, callback) {
        value = value.toFixed(1)
        var url = this.apiroute + '/status/?changestatus=true&heatingThresholdTemperature?value=' + value
